...
// her hender jeg værdierne til vores drop down menuer fra HTML
    let dayFilter = document.querySelector("#filterDay").value;
    let locationFilter = document.querySelector("#filterLocation").value;
    let timeFilter = document.querySelector("#filterTid").value;
// Her benytter jeg en loop hvor jeg benytter forEach => da vi har et array.Her benytter jeg filter metoden til at filtrere vores events
    let filteredEvents = events.filter(event => 
        ...
        (timeFilter === "all" || event.time === timeFilter)
